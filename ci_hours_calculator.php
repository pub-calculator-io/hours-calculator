...
Version: 1.0.0
Author: Hours Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Hours Calculator by www.calculator.io";

function display_calcio_ci_hours_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_hours_calculator', 'display_calcio_ci_hours_calculator' );